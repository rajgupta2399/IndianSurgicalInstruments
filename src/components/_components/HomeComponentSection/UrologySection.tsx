...
import UC1 from "../../../assets/Urology-care-category.png";
import UC2 from "../../../assets/Ureteral-Catheter-1.jpg";
import UC3 from "../../../assets/Urine-Bags-1.jpg";
import UC4 from "../../../assets/Catheters-1.jpg";
...
export default function UrologyCareSection() {
  const [urologyProducts, setUrologyProducts] =
  ...
  if (!urologyProducts?.items?.length) return null;
  ...
  return (
    <div className="relative space-y-4 overflow-hidden py-2">
      ...
      <div className="relative mx-auto w-full max-w-screen-xl">
        ...
        >
          <CarouselContent className="flex">
            {urologyProducts.items.map((product) => (
              <CarouselItem
